...
public class ProjectGuestIntervalServiceImpl  implements ProjectGuestIntervalService{
    ...
    public void saveProject(ProjectGuestInterval projectGuestInterval) {
        ...
        Integer hl = 0;
        //通过签约id查询签约信息
     /*   Contract contract =  contractCQRSService.findContractById(projectGuestInterval.getContractId());*/

        //通过签约id查询签约信息
      /*  List<TimingByConditionResponseDTO> timingByConditionResponseDTOS = triangleCQRSService.findByConditionId(projectGuestInterval.getContractId());
        ...
        brandTriangleRequestDTO.setProjectId(timingByConditionResponseDTO.getProjectId());
        brandTriangleRequestDTO.setBrandId(timingByConditionResponseDTO.getBrandId());
        //楼层id
        brandTriangleRequestDTO.setFloorId(timingByConditionResponseDTO.getFloorId());
        //业态id
        brandTriangleRequestDTO.setConditionId(timingByConditionResponseDTO.getConditionId());
        //业种id
        brandTriangleRequestDTO.setMajoId(timingByConditionResponseDTO.getMajoId());*/
