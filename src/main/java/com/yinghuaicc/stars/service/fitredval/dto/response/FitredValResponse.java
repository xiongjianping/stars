package com.yinghuaicc.stars.service.fitredval.dto.response;
 ...
 */
public class FitredValResponse {
    private String id;
    private String fitredType; //类型 1，适合度，2配合度
    private String name;//名称
    private String val;//最大值
    //创建时间
