...
public class FloorRateServiceImpl implements FloorRateService {
    ...
    public BigDecimal getSyFloorRateCount(FloorRateSy FloorRate) {
        ...
        BigDecimal rx = zkll.divide(acreage.multiply(day),2,BigDecimal.ROUND_UP); // 1 楼层客流量除以面积
        ...
        BigDecimal px = sale.divide(acreage.multiply(day),2,BigDecimal.ROUND_UP); //销售额 / 面积*时间擦
